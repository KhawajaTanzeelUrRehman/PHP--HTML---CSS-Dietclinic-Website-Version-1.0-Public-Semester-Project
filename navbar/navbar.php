        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../log_in/log_in_page.php">Log In</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="ProgramDropdown">
                            <li><a class="dropdown-item" href="../Programs/Cards.php">Weight Management Program</a></li>
                            <li><a class="dropdown-item" href="../Programs/Cards.php">Post Partum Program</a></li>
                            <li><a class="dropdown-item" href="../Programs/Cards.php">Therapeutic Disease Based
                                    Programs</a></li>
                        </ul>
                    </li>
